...
export default class HeaderTop extends Component {
  ...
  toggleCollapsed = () => {
    ...
    if (this.props.toggleCollasped) {
      this.props.toggleCollasped();
    }
  };

  setColor = (color) => {
    window.sessionStorage.setItem("color_theam", color);
  };
  render() {
    ...
    return (
      <>
        ...
        <Row gutter={[0, 0]}>
          ...
          <Col md={1} span={24}>
            <span className="cuspointer" onClick={this.toggleCollapsed}>
              {toggler}
            </span>
          </Col>
          <Col span={24} md={17} className="header-control">
            <Badge size="large" count={4}>
                  ...
                  <div className="theme-color mb-2">
                    <ButtonContainer>
                      <Button
                        type="primary"
                        onClick={() => {
                          this.props.handleSidebarColor("#1890ff");
                      ...
                      <Button
                        type="success"
                        onClick={() => {
                          this.props.handleSidebarColor("#52c41a");
                      ...
                      <Button
                        type="danger"
                        onClick={() => {
                          this.props.handleSidebarColor("#d9363e");
                          this.setColor("#d9363e");
                        }}
                      >
                        1
                      </Button>
                      <Button
                        type="yellow"
                        onClick={() => {
                          this.props.handleSidebarColor("#fadb14");
                          this.setColor("#fadb14");
                        }}
                      >
                        1
                      </Button>
                      ...
                      <Button
                        type="black"
                        onClick={() => {
                          this.props.handleSidebarColor("black");
                          this.setColor("black");
                        }}
                      >
                        1
